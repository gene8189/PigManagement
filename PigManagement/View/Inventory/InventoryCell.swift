...
class InventoryCell: BaseCell {
    ...
    override init(frame: CGRect) {
        ...
        circle.anchor(top: nil, leading: numberLabel.trailingAnchor, bottom: nil, trailing: percentageLabel.leadingAnchor, padding: .init(top: 0, left: 10, bottom: 0, right: 20), size: .init(width: 100, height: 100))
        circle.centerYInSuperview()
        percentageLabel.anchor(top: nil, leading: circle.trailingAnchor, bottom: nil, trailing: arrowImageView.leadingAnchor, padding: .init(top: 0, left: 20, bottom: 0, right: 20), size: .init(width: 70, height: 50))
